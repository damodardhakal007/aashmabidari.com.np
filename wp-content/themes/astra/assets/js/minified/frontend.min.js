...
astraSmoothScroll = function(e, t) {
    ...
    function t(e) {
        ...
        if (void 0 === e && null !== m)
            if (g = m.querySelector("#ast-mobile-header")) e = g.dataset.type;
                ...
                var s = m.querySelector("#ast-desktop-header");
                if (!s) return;
        ...
        if ("off-canvas" === e) {
            ...
            if (null != o) {
                ...
                s.addEventListener("click", function(e) {
                    ...
                    "Escape" === e.key && (e.preventDefault(), document.getElementById("ast-mobile-popup").classList.remove("active", "show"), p(), t ? .focus())
                }), document.addEventListener("click", function(e) {
                            ...
                            e && e.forEach(e => {
                                ...
                                e.querySelectorAll(".main-header-menu .menu-item > a").forEach(e => {
                                    e.addEventListener("focusout", function(e) {
                                        ...
                                        if (!(t == a || r && r == a))
                                            if (null == a) s && h(s), n && h(n);
                                            else if (t.nextElementSibling == a || t.previousElementSibling == a) e && (h(n, !1), t.classList.remove("ast-menu-hover"));
                                        else if (o && o == a) h(childSubMenu = t.querySelector(".sub-menu"), !1);
                                        else {
                                            let e = o,
                                                t = null;
                                            for (; null != e;) {
    ...
    for (var a, n, o = function() {
        ...
        }, l = (o(), AstraToggleSubMenu = function(e) {
    ...
    function h(e, t = !0, a = null) {
        ...
        n && n.setAttribute("aria-expanded", "false"), (t = a ? !0 : t) && null !== (n = e.parentElement.closest(".sub-menu")) && e !== a && h(n, !0, a)
    }
